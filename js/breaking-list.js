$(function () {
  ...
  (async () => {
    ...
    for (const element of imageElements) {
      ...
      console.log(`${window.location.origin}/pdf/breaking-news/${requiredDate}/breaking-news.png`);
      element.style.backgroundImage = `url(${window.location.origin}/pdf/breaking-news/${requiredDate}/breaking-news.png)`;
    }
    ...
    for (const element of hrefElements) {
      ...
      element.href = `${window.location.origin}/breaking-news.html?date=${requiredDate}`
    }
  })();
